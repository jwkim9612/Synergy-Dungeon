...
public class UIRuneForCombination : UIRune
{
    ...
    public void SetButtonForUnselected()
    {
        ...
        {
            var uiCombinationSpace = MainManager.instance.uiIllustratedBook.uiRunePage.uiRuneCombination.uiCombinationSpace;
    ...
    public void Release(UISelectedRuneSpace uiSelectedRuneSpace)
    {
        ...
        var uiRuneCombination = MainManager.instance.uiIllustratedBook.uiRunePage.uiRuneCombination;
